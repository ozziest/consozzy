...
class Kernel
{
	...
	*/
	public function _init()
	{
		...
		*/
		$this->languageSelection = $configs->language;
		self::$userMessageStatus = $configs->userMessageStatus;
		self::$userErrorMessageStatus = $configs->userErrorMessageStatus;
		self::$colorStatus = $configs->colorStatus;
